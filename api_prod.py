...
opbeat = Opbeat(
    app,
    organization_id='03ae486310c9438e90832006a02a8d91',
    app_id='c933b94901',
    secret_token='45c0f89d1402722b48066a9d84d5bbb96100f793',
)

# Variable routing method retrieves original url and redirects browser to it -> increments visit count by 1
...
@app.route('/lastHundred', methods=['GET'])
def lastHundred():
    conn, cursor = getConnObjects(mysql)
...
@app.route('/trackInfo/<shortURL>', methods=['GET'])
def trackInfo(shortURL):     
...
@app.route('/customURL', methods=['POST'])
def customURL():
...
# insert method takes in original url -> returns id of inserted record which is encoded to base62
